                        ...
                        <form action="{{ route('dashboard.product.update', $item->id) }}" class="w-full" method="post"
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="block w-full px-3 mb-5">
                                    ...
                                    <input type="text" id="name" value="{{ old('name') ?? $item->name }}" name="name" autocomplete="off" 
                                        placeholder="Name"
                                ...
                                <div class="block w-full px-3 mb-5">
                                    ...
                                    <input type="number" id="price" value="{{ old('price') ?? $item->price }}" name="price"
                                        placeholder="Price"
                                        class="block w-full bg-gray-100 text-gray-700 rounded py-3 px-4 leading-tight border-none focus:outline-none focus:bg-white focus:border-gray-700">
                                </div>
                                <div class="block w-full px-3 mb-5">
                                    ...
                                    <textarea id="description" name="description"
                                        class="block w-full bg-gray-100 text-gray-700 rounded py-3 px-4 leading-tight border-none focus:outline-none focus:bg-white focus:border-gray-700">{!! old('description') ?? $item->description !!}</textarea>
                                </div>
